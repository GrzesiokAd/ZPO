...
public class ZadanieServiceImpl implements ZadanieService {
	...
	public Optional<Zadanie> getZadanie(Integer zadanieId) {
		...
		try {
			...
			logger.warn("Nie znaleziono zadania o id {}", zadanieId);
	...
	public Zadanie setZadanie(Zadanie zadanie) {
		...
		return location == null ? zadanie : getCreatedZadanie(location);
	}
	...
	private Zadanie getCreatedZadanie(URI location) {
	...
	private Page<Zadanie> getPage(URI uri) {
		return ServiceUtil.getPage(uri, restClient, new ParameterizedTypeReference<RestResponsePage<Zadanie>>() {
		});
	}
}
