...
public class ProjektServiceImpl implements ProjektService {
	...
	public Optional<Projekt> getProjekt(Integer projektId) {
		...
		try {
			...
			logger.warn("Nie znaleziono projektu o id {}", projektId);
	...
	public Projekt setProjekt(Projekt projekt) {
		...
		return location == null ? projekt : getCreatedProjekt(location);
	}
	...
	private Projekt getCreatedProjekt(URI location) {
	...
	private Page<Projekt> getPage(URI uri) {
		return ServiceUtil.getPage(uri, restClient, new ParameterizedTypeReference<RestResponsePage<Projekt>>() {
		});
	}
}
